...
private:
	static LPDIRECT3DTEXTURE9 m_pTexture[MAX_ITEM_TEXTURE];	//テクスチャのポインタ配列
	static CItem *m_pItem[MAX_ITEM];						//アイテムのポインタ配列
	LPDIRECT3DTEXTURE9 m_apScene[MAX_ITEM_TEXTURE];			//シーンのポインタ配列
	D3DXVECTOR3 m_move;										//移動量
	int m_nItemCounter;										//アイテムタイプのカウント
	ITEMTYPE m_ItemType;									//アイテムタイプの保存用
};
