	...
	for (int nCntScene = 0; nCntScene < MAX_OBJECT; nCntScene++)
	{
		...
		if (pBarrier != NULL)
		{
			...
			case OBJTYPE_BOSS_BALL:
				...
				if (CollisionCircularAndCircular(pos,BarrierPos,BOSS_BALL_RADIUS,BARRIER_RADIUS))
				{
					//SEの再生
			...
			case OBJTYPE_FIRST_BALL:
				...
				if (CollisionCircularAndCircular(pos, BarrierPos, FIRST_BALL_RADIUS, BARRIER_RADIUS))
				{
					//SEの再生
					CManager::GetSound()->Play(CSound::SOUND_LABEL_SE_HIT1);
			...
			case OBJTYPE_SECOND_BALL:
				...
				if (CollisionCircularAndCircular(pos, BarrierPos, SECOND_BALL_RADIUS, BARRIER_RADIUS))
				{
					//SEの再生
					CManager::GetSound()->Play(CSound::SOUND_LABEL_SE_HIT1);
			...
			case OBJTYPE_THIRD_BALL:
				...
				if (CollisionCircularAndCircular(pos, BarrierPos, THIRD_BALL_RADIUS, BARRIER_RADIUS))
				{
					//SEの再生
					CManager::GetSound()->Play(CSound::SOUND_LABEL_SE_HIT1);
